...
from util import getLongestSeqDict, genBitMatrix, numOfAlignedChars, numOfInsertedIndels, bitsToStrings, test1
...
wow = MSAMGPSO(test1, [-2.0, 2.0], 30, 0.729844, 1.49618, 1.49618, 1.49618, .5, 3, float('inf'), 500, [float('inf'), -float('inf')], 5000)

for res in wow:
    print(numOfAlignedChars(bitsToStrings(res[1], test1)))
    print(numOfInsertedIndels(res[1], test1))
